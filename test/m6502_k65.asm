...
.endmacro
.macro	SKIP1
	.byte 0o044	;BIT ZERO PAGE TRICK.
.endmacro
.macro	SKIP2
	.byte 0o054	;BIT ABS TRICK.
.endmacro
.IF 1
.IFE	REALIO==0
PRINTX/SIMULATE/
...
; 1/24/78 fixed problem where user .macrod function un.macrod check fix was smashing error number in [x]
...
; 		NUMBER OR USER .macroD FUNCTION. THE FIRST TWO
...
; 		USER .macroD FUNCTION VALUES ALSO CONTAIN
; 		POINTERS INTO SIMPLE VARIABLE SPACE SO NO USER-.macroD
...
;AND RETURN.
EVAL4: CMP #FNTK ;USER-.macroD FUNCTION?
...
BEQ GIVAYF ;FLOAT IT.
; PAGE
; SUBTTL	SIMPLE-USER-.macroD-FUNCTION CODE.
;
...
.word 512,44
ERRGUF: LDX #ERRUF ;USER .macroD FUNCTION NEVER .macroD
ERRGO1: JMP ERROR
